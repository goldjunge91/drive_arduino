...
T012. Register state & command interfaces (wheels, servos, ESCs) [ROS2-CONTROL]
...
T013. Integrate protocol library into hardware interface [PROTOCOL][ROS2-CONTROL]
...
T014. Add latency measurement instrumentation [LATENCY]
...
T015. Create Pico firmware skeleton project [P] [FIRMWARE]
...
T016. Implement Pico CRC + frame parser state machine [FIRMWARE][PROTOCOL]
