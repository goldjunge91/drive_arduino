#ifndef MECABRIDGE_HARDWARE__MECABRIDGE_HARDWARE__MECABRIDGE_DRIVE_CONFIG__H_
#define MECABRIDGE_HARDWARE__MECABRIDGE_HARDWARE__MECABRIDGE_DRIVE_CONFIG__H_
...
#endif  // MECABRIDGE_HARDWARE__MECABRIDGE_HARDWARE__MECABRIDGE_DRIVE_CONFIG__H_
