#ifndef MECABRIDGE_HARDWARE__MECABRIDGE_UTILS__PROTOCOL__SCALING__HPP_
#define MECABRIDGE_HARDWARE__MECABRIDGE_UTILS__PROTOCOL__SCALING__HPP_
...
#endif  // MECABRIDGE_HARDWARE__MECABRIDGE_UTILS__PROTOCOL__SCALING__HPP_
