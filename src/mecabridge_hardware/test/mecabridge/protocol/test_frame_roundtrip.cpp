...
TEST_F(FrameRoundtripTest, CommandFrameSize) {
    ...
    mecabridge::protocol::ErrorCode result = mecabridge::protocol::encodeCommand(cmd, buffer, sizeof(buffer), bytes_written);
...
TEST_F(FrameRoundtripTest, StateFrameSize) {
    ...
    mecabridge::protocol::ErrorCode result = mecabridge::protocol::encodeState(state, buffer, sizeof(buffer), bytes_written);
...
TEST_F(FrameRoundtripTest, BufferTooSmall) {
    ...
    mecabridge::protocol::ErrorCode result = mecabridge::protocol::encodeCommand(cmd, small_buffer, sizeof(small_buffer), bytes_written);
...
TEST_F(FrameRoundtripTest, FrameParsingPlaceholder) {
    ...
    mecabridge::protocol::ErrorCode encode_result = mecabridge::protocol::encodeCommand(cmd, buffer, sizeof(buffer), bytes_written);
