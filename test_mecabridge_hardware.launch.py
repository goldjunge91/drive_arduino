...
def generate_launch_description():
    ...
    controller_manager = Node(
        ...
        parameters=[{
            ...
            <robot name="test_robot">
              <ros2_control name="mecabridge_hardware" type="system">
                <hardware>
                  <plugin>mecabridge_hardware/MecaBridgeHardwareInterface</plugin>
    ...
    error_test_node = Node(
        ...
        executable='test_mecabridge_error_handling.py',
        output='screen',
